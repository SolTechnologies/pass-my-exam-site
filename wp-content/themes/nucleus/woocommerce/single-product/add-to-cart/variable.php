...
<form class="variations_form cart" method="post" enctype='multipart/form-data'
	...
	<?php if ( empty( $available_variations ) && false !== $available_variations ) : ?>
		<p class="stock out-of-stock"><?php esc_html_e( 'This product is currently out of stock and unavailable.', 'nucleus' ); ?></p>
	<?php else : ?>
				...
				<div class="space-bottom">
					...
					<div class="value">
						...
						wc_dropdown_variation_attribute_options( array(
							...
							'product'   => $product,
							'selected'  => $selected,
							'class'     => 'space-bottom-none',
						) );

						echo end( $attribute_keys ) === $attribute_name
							? apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations" href="#">' . __( 'Clear', 'nucleus' ) . '</a>' )
							: '';
						?>
					</div>
				</div>
