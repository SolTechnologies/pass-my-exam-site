...
/**
 * Filter the "nucleus_app_store" default shortcode attributes
 *
 * @param array $atts Pairs of default attributes
 */
$a = shortcode_atts( apply_filters( 'nucleus_shortcode_app_store_atts', array(
	'link'             => '',
 ...
 */
$image     = apply_filters( 'nucleus_shortcode_app_store_bg', NUCLEUS_CORE_URI . '/img/app-store.png' );
