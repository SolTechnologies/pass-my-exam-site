...
/**
 * Filter the "nucleus_amazon" default shortcode attributes
 *
 * @param array $atts Pairs of default attributes
 */
$a = shortcode_atts( apply_filters( 'nucleus_shortcode_amazon_atts', array(
	'link'             => '',
 ...
 */
$image     = apply_filters( 'nucleus_shortcode_amazon_bg', NUCLEUS_CORE_URI . '/img/amazon.png' );
