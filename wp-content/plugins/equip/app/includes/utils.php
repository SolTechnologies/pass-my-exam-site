...
if ( ! function_exists( 'equip_get_networks' ) ) :
	 ...
	 *
	 * @see assets/misc/networks.ini
	 *
	 * @return array
	 */
	function equip_get_networks() {
		/**
		 * Change the path to file networks.ini
		 *
		 * In case if you need completely change the data
		 * 
		 * @param string $path Absolute path to networks.ini
		 */
		$path = apply_filters( 'equip/networks/path', EQUIP_ASSETS_DIR . '/misc/networks.ini' );
