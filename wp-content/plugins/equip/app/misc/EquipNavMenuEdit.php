...
/**
 * Modified version of {@see Walker_Nav_Menu_Edit}.
 *
 * Create HTML list of nav menu input items with custom field(s).
 *
 ...
 * @package Equip\Misc
 */
class EquipNavMenuEdit extends \Walker_Nav_Menu_Edit {
	...
	<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
			...
			<div class="menu-item-handle">
				<span class="item-title"><span
						...
						<span class="item-controls">
							<span
								class="item-type"><?php echo esc_html( $item->type_label ); ?></span>
							<span class="item-order hide-if-js">
								...
								?>" class="item-move-down"><abbr
										title="<?php esc_attr_e( 'Move down' ); ?>">
										&#8595;</abbr></a>
							</span>
		...
		<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
			...
			<?php
			/**
			 * Engine the Equip fields
			 *
			 * @param int    $item_id Menu item ID
			 * @param object $item    Menu item data object.
			 */
			do_action( 'equip/menu/render', $item_id, $item );
			?>
			...
			<input class="menu-item-data-db-id" type="hidden"
			       name="menu-item-db-id[<?php echo $item_id; ?>]" value="<?php echo $item_id; ?>"/>
