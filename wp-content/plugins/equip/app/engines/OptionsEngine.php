					...
					<footer class="equip-footer stuck">
						<div class="footer-inner">
							...
							<div class="equip-btn-group">
								<button type="submit" name="submit" class="equip-btn btn-primary waves-effect">
									<i class="material-icons done"></i>
									<span><?php esc_html_e( 'Save Changes', 'equip' ); ?></span>
								</button>
								<a href="#" class="equip-btn btn-warning waves-effect" id="equip-options-reset-section">
									<i class="material-icons clear"></i>
									<span><?php esc_html_e( 'Reset Section', 'equip' ); ?></span>
								</a>
								<a href="#" class="equip-btn btn-danger waves-effect" id="equip-options-reset">
